...
#define OEDCS_VERSION "; Rev: 0.4.10"  // Improving Thermocouple Handling
...
void setup()
{
  ...
  CogCore::DebugLn<long>((long) hal);
  CogCore::DebugLn<long>((long) hal->_fans[0]);
  CogCore::DebugLn<long>((long) hal->_fans[0]->getRPM());
